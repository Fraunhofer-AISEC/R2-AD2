...
# Configuration
this_parse = ArgumentParser(description="Train R2-AD2 on DoH")
add_standard_arguments(this_parse)
this_args = this_parse.parse_args()

experiment_config = [
    DoH(
        random_state=this_args.random_seed, y_normal=["Benign"], y_anomalous=["Malicious"],
